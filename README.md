...
This repository contains the smartOwa OpenMRS Open Web App.
...
This will create a file called `smartowa.zip` file in the `dist` directory,
...
This will build and deploy the app to the `http://localhost:8080/openmrs/owa/smC:/Users/admin/openmrar`
...
```js
{
  "LOCAL_OWA_FOLDER": "http://localhost:8080/openmrs/owa/smC:/Users/admin/openmrar"
}
```
...
{
  "LOCAL_OWA_FOLDER": "http://localhost:8080/openmrs/owa/smC:/Users/admin/openmrar",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/smar"
}
```
