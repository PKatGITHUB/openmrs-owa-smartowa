 ...
 */
// generated on 2018-07-23 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/smartowa`,
	  css: `${__dirname}/app/css/smartowa.css`,
	  vendor : [
	        	 'jquery' 
